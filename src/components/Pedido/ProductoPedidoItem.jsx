			...
			<div className='card-body'>
				<div className='d-flex justify-content-around flex-wrap'>
					...
					<div className='col-lg-6'>
						<h5 className='colorLetra'>
							{detallePedido.producto.nombre}
						</h5>
						<h6 className='colorLetra2'>
					...
					<div className='col-lg-2  d-flex justify-content-end flex-wrap'>
						<div className='row'>
							<button
								className='btn border-0 rounded-circle p-2 btn-circuloverde m-0'
								style={{ background: '#EE814A' }}>
